...
if st.button("Try AI"):
    ...
    st.image("/home/sommay/Pictures/s/Screenshot_2026-06-12_19-31-48.png")
    ...
    st.image("/home/sommay/Pictures/s/Screenshot_2026-06-12_19-49-38.png")
    st.text("the last step is emter this command in terminal:-")
    with st.expander("Show Code"):
      with open("/home/sommay/Desktop/code/TipsAI/tips.py", "r") as f:
         content = f.read()
